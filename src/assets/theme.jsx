...
function ThemeIcon({ fill, className }) {
  return (
    <div>
      <svg
        width="800px"
...
ThemeIcon.propTypes = {
  fill: PropTypes.string | PropTypes.number,
